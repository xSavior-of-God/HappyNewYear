package com.xSavior_of_God.HeroxWar.HappyNewYear.utils;
...
public class Utils {
    ...
    public static boolean stringTimeIsBetween(String start, String stop, String target) {
        return (LocalTime.parse(target).isAfter(LocalTime.parse(start))
                || LocalTime.parse(target).isBefore(LocalTime.parse(stop)));
    }
